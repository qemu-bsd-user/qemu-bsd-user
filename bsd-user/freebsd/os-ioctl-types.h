...
STRUCT(ifstat,
    MK_ARRAY(TYPE_CHAR, TARGET_IFNAMSIZ), MK_ARRAY(TYPE_CHAR, TARGET_IFSTATMAX + 1))

STRUCT(ieee80211req,
    MK_ARRAY(TYPE_CHAR, TARGET_IFNAMSIZ), TYPE_SHORT, TYPE_SHORT, TYPE_SHORT, TYPE_PTRVOID)

STRUCT(lagg_reqport_lacp_opreq,
    MK_ARRAY(TYPE_CHAR, TARGET_IFNAMSIZ), MK_ARRAY(TYPE_CHAR, TARGET_IFNAMSIZ), TYPE_INT,
    TYPE_INT,
    /* struct lacp_opreq */
    TYPE_SHORT, MK_ARRAY(TYPE_CHAR, ETHER_ADDR_LEN), TYPE_SHORT, TYPE_SHORT, TYPE_SHORT, TYPE_CHAR,
    TYPE_SHORT, MK_ARRAY(TYPE_CHAR, ETHER_ADDR_LEN), TYPE_SHORT, TYPE_SHORT, TYPE_SHORT, TYPE_CHAR)

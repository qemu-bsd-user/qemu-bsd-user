                                ...
                                abi_long arg8)
{
    ...
    case TARGET_FREEBSD_NR_cap_enter:        /* cap_enter(2) */
        /*
         * The rights would apply to qemu's own descriptors, and capability
         * mode would stop qemu opening the guest's libraries. ENOSYS is not
         * an option: the cpu loop turns it into SIGSYS.
         */
        ret = 0;
        break;
